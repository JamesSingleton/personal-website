      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m James, a software enginer for Zendesk based in Maricopa,
            Arizona. I&apos;m the founder of Redshirt Sports, where I along with
            a team of writers report on FCS College Football.
          </p>
